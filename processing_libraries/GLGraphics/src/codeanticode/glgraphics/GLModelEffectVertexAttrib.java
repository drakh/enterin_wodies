...
public class GLModelEffectVertexAttrib extends GLSLShaderAttribute {
  /**
   * Creates an instance of GLModelEffectVertexAttrib using the specified
   ...
   * @param type int
   */
  public GLModelEffectVertexAttrib(PApplet parent, String name, String label,
      int type) {
   ...
   * @param type int
   */
  public GLModelEffectVertexAttrib(PApplet parent, GLSLShader shader,
